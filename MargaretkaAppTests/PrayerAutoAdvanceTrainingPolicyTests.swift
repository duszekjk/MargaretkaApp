...
struct PrayerAutoAdvanceTrainingPolicyTests {
    ...
    @Test func manualGestureIsTrainingAnchorWithoutInventedCompletionDelay() throws {
    ...
    @Test func calibrationBuildsBothClassesWithoutTextComparisonHeuristics() throws {
        let base = Date(timeIntervalSince1970: 1_700_000_000)
