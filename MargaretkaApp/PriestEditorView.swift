...
struct PriestEditorView: View {
    ...
    private var devicePhotoMaxDimension: CGFloat {
        photoLayoutFamily == .iPad ? 1600 : 1920
    }

    private var devicePhotoByteLimit: Int {
        photoLayoutFamily == .iPad ? 900_000 : 1_200_000
    }
...
#if os(iOS) || os(tvOS) || os(visionOS)
extension UIImage {
    static let storagePhotoByteLimit = 1_200_000
    static let storagePhotoMaxDimension: CGFloat = 1920
